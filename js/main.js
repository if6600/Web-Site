            ...
            document.getElementById('common').onclick = changeOpacity
              function changeOpacity() {
                ...
                if (onclickOnCubes % 2 === 0) {
                  ...
                  romb.style.transition = '350ms'
                  cubekatalog2.style.transition = '350ms'
                  circ1.style.transition = '350ms'
                  circ2.style.transition = '350ms'
                  cubekatalog2_2.style.transition = '350ms'
                  circblcnwht.style.transition = '350ms'
                  cubekatalog2_4.style.transition = '350ms'
                  circstr.style.transition = '350ms'
                  cubekatalog2_1.style.transition = '350ms'
                  circube.style.transition = '350ms'
                  cubekatalog3_2.style.transition = '350ms'
                  moon.style.transition = '350ms'
                  cubekatalog3_4.style.transition = '350ms'
                  circles.style.transition = '350ms'
                  cubekatalog3_5.style.transition = '350ms'
                  sparkles.style.transition = '350ms'
                  cubekatalog4_1.style.transition = '350ms'
                  twocirc.style.transition = '350ms'
                  cubekatalog4_2.style.transition = '350ms'
                  str.style.transition = '350ms'
                  cubekatalog4_3.style.transition = '350ms'
                  str2.style.transition = '350ms'
                  cubekatalog4_4.style.transition = '350ms'
                  str3.style.transition = '350ms'
                  cubekatalog4_5.style.transition = '350ms'
                  triangle.style.transition = '350ms'
                  cubekatalog4_6.style.transition = '350ms'
                  blccirc.style.transition = '350ms'
                  cubekatalog5_1.style.transition = '350ms'
                  sputnic.style.transition = '350ms'
                  cubekatalog5_2.style.transition = '350ms'
                  blcstr.style.transition = '350ms'
                  cubekatalog5_4.style.transition = '350ms'
                  planet.style.transition = '350ms'
                  cubekatalog5_5.style.transition = '350ms'
                  kolba.style.transition = '350ms'
                  cubekatalog5_6.style.transition = '350ms'
                  strd.style.transition = '350ms'
                  cubekatalog6_3.style.transition = '350ms'
                  strblc2.style.transition = '350ms'
                  cubekatalog7_3.style.transition = '350ms'
                  comet.style.transition = '350ms'
                  cubekatalog7_4.style.transition = '350ms'
                } else {
              ...
              document.getElementById('uncommon').onclick = changeOpacityUnc
                function changeOpacityUnc() {
                  ...
                  if (onclickOnCubeUnc % 2 === 0) {
                    ...
                    ellipse.style.transition = '350ms'
                    cubekatalog.style.transition = '350ms'
                    sparc.style.transition = '350ms'
                    cubekatalog2_3.style.transition = '350ms'
                    blackcirc.style.transition = '350ms'
                    cubekatalog2_22.style.transition = '350ms'
                    blacknwhite.style.transition = '350ms'
                    cubekatalog2_44.style.transition = '350ms'
                    blackcirc2.style.transition = '350ms'
                    romb1.style.transition = '350ms'
                    cubecatalog2.style.transition = '350ms'
                    cmn.style.transition = '350ms'
                    cubecatalog3_11.style.transition = '350ms'
                    cmn2.style.transition = '350ms'
                    cubecatalog3_22.style.transition = '350ms'
                    cmn3.style.transition = '350ms'
                    cubecatalog3_33.style.transition = '350ms'
                    cmn4.style.transition = '350ms'
                    cubecatalog3_44.style.transition = '350ms'
                    cmn5.style.transition = '350ms'
                    cubecatalog3_55.style.transition = '350ms'
                    cmn6.style.transition = '350ms'
                    cubecatalog3_66.style.transition = '350ms'
                    cmn7.style.transition = '350ms'
                    cubecatalog4_44.style.transition = '350ms'
                    cmn8.style.transition = '350ms'
                    cubecatalog4_66.style.transition = '350ms'
                    cmn9.style.transition = '350ms'
                    cubecatalog5_11.style.transition = '350ms'
                    cmn10.style.transition = '350ms'
                    cubecatalog5_33.style.transition = '350ms'
                    cmn11.style.transition = '350ms'
                    cubecatalog5_44.style.transition = '350ms'
                    cmn12.style.transition = '350ms'
                    cubecatalog5_66.style.transition = '350ms'
                    cmn13.style.transition = '350ms'
                    cubecatalog6_1.style.transition = '350ms'
                    cmn14.style.transition = '350ms'
                    cubecatalog6_2.style.transition = '350ms'
                    cmn15.style.transition = '350ms'
                    cubecatalog6_5.style.transition = '350ms'
                    cmn16.style.transition = '350ms'
                    cubecatalog7_33.style.transition = '350ms'
                  } else {
                ...
                // Каталог rare фигур
                let num1 = document.querySelector(".figure1")
                let cub1 = document.querySelector(".cubekatalog")
                let num2 = document.querySelector(".figure2_1")
                let cub2 = document.querySelector(".cubekatalog2_1")
                let num3 = document.querySelector(".figure2_3")
                let cub3 = document.querySelector(".cubekatalog2_3")
                let num4 = document.querySelector(".figure3_1")
                let cub4 = document.querySelector(".cubekatalog3_1")
                let num5 = document.querySelector(".figure3_3")
                let cub5 = document.querySelector(".cubekatalog3_3")
                let num6 = document.querySelector(".figure3_6")
                let cub6 = document.querySelector(".cubekatalog3_6")
                let num7 = document.querySelector(".figure4_1")
                let cub7 = document.querySelector(".cubekatalog4_1")
                let num8 = document.querySelector(".figure4_2")
                let cub8 = document.querySelector(".cubekatalog4_2")
                let num9 = document.querySelector(".figure4_3")
                let cub9 = document.querySelector(".cubekatalog4_3")
                let num10 = document.querySelector(".figure4_5")
                let cub10 = document.querySelector(".cubekatalog4_5")
                let num11 = document.querySelector(".figure5_2")
                let cub11 = document.querySelector(".cubekatalog5_2")
                let num12 = document.querySelector(".figure5_3")
                let cub12 = document.querySelector(".cubekatalog5_3")
                let num13 = document.querySelector(".figure5_5")
                let cub13 = document.querySelector(".cubekatalog5_5")
                let num14 = document.querySelector(".figure6_1")
                let cub14 = document.querySelector(".cubekatalog6_2")
                let num15 = document.querySelector(".figure6_2")
                let cub15 = document.querySelector(".cubekatalog6_3")
                let num16 = document.querySelector(".figure6_3")
                let cub16 = document.querySelector(".cubekatalog6_4")
                let num17 = document.querySelector(".figure6_4")
                let cub17 = document.querySelector(".cubekatalog6_5")
                let num18 = document.querySelector(".figure7_2")
                let cub18 = document.querySelector(".cubekatalog7_4")
                ...
                document.getElementById('rare').onclick = changeOpacityRare
                  function changeOpacityRare() {
                    ...
                    if (onclickOnCubesRare % 2 === 0) {
                      num1.style.opacity = '30%'
                      cub1.style.opacity = '30%'
                      num2.style.opacity = '30%'
                      cub2.style.opacity = '30%'
                      num3.style.opacity = '30%'
                      cub3.style.opacity = '30%'
                      num4.style.opacity = '30%'
                      cub4.style.opacity = '30%'
                      num5.style.opacity = '30%'
                      cub5.style.opacity = '30%'
                      num6.style.opacity = '30%'
                      cub6.style.opacity = '30%'
                      num7.style.opacity = '30%'
                      cub7.style.opacity = '30%'
                      num8.style.opacity = '30%'
                      cub8.style.opacity = '30%'
                      num9.style.opacity = '30%'
                      cub9.style.opacity = '30%'
                      num10.style.opacity = '30%'
                      cub10.style.opacity = '30%'
                      num11.style.opacity = '30%'
                      cub11.style.opacity = '30%'
                      num12.style.opacity = '30%'
                      cub12.style.opacity = '30%'
                      num13.style.opacity = '30%'
                      cub13.style.opacity = '30%'
                      num14.style.opacity = '30%'
                      cub14.style.opacity = '30%'
                      num15.style.opacity = '30%'
                      cub15.style.opacity = '30%'
                      num16.style.opacity = '30%'
                      cub16.style.opacity = '30%'
                      num17.style.opacity = '30%'
                      cub17.style.opacity = '30%'
                      num18.style.opacity = '30%'
                      cub18.style.opacity = '30%'
                      num1.style.transition = '350ms'
                      cub1.style.transition = '350ms'
                      num2.style.transition = '350ms'
                      cub2.style.transition = '350ms'
                      num3.style.transition = '350ms'
                      cub3.style.transition = '350ms'
                      num4.style.transition = '350ms'
                      cub4.style.transition = '350ms'
                      num5.style.transition = '350ms'
                      cub5.style.transition = '350ms'
                      num6.style.transition = '350ms'
                      cub6.style.transition = '350ms'
                      num7.style.transition = '350ms'
                      cub7.style.transition = '350ms'
                      num8.style.transition = '350ms'
                      cub8.style.transition = '350ms'
                      num9.style.transition = '350ms'
                      cub9.style.transition = '350ms'
                      num10.style.transition = '350ms'
                      cub10.style.transition = '350ms'
                      num11.style.transition = '350ms'
                      cub11.style.transition = '350ms'
                      num12.style.transition = '350ms'
                      cub12.style.transition = '350ms'
                      num13.style.transition = '350ms'
                      cub13.style.transition = '350ms'
                      num14.style.transition = '350ms'
                      cub14.style.transition = '350ms'
                      num15.style.transition = '350ms'
                      cub15.style.transition = '350ms'
                      num16.style.transition = '350ms'
                      cub16.style.transition = '350ms'
                      num17.style.transition = '350ms'
                      cub17.style.transition = '350ms'
                      num18.style.transition = '350ms'
                      cub18.style.transition = '350ms'
                    } else {
                      num1.style.opacity = '100%'
                      cub1.style.opacity = '100%'
                      num2.style.opacity = '100%'
                      cub2.style.opacity = '100%'
                      num3.style.opacity = '100%'
                      cub3.style.opacity = '100%'
                      num5.style.opacity = '100%'
                      cub5.style.opacity = '100%'
                      num6.style.opacity = '100%'
                      cub6.style.opacity = '100%'
                      num7.style.opacity = '100%'
                      cub7.style.opacity = '100%'
                      num8.style.opacity = '100%'
                      cub8.style.opacity = '100%'
                      num9.style.opacity = '100%'
                      cub9.style.opacity = '100%'
                      num10.style.opacity = '100%'
                      cub10.style.opacity = '100%'
                      num11.style.opacity = '100%'
                      cub11.style.opacity = '100%'
                      num12.style.opacity = '100%'
                      cub12.style.opacity = '100%'
                      num13.style.opacity = '100%'
                      cub13.style.opacity = '100%'
                      num14.style.opacity = '100%'
                      cub14.style.opacity = '100%'
                      num15.style.opacity = '100%'
                      cub15.style.opacity = '100%'
                      num16.style.opacity = '100%'
                      cub16.style.opacity = '100%'
                      num17.style.opacity = '100%'
                      cub17.style.opacity = '100%'
                      num18.style.opacity = '100%'
                      cub18.style.opacity = '100%'
                    }
                  }
